...
def ensemble(n, nh, lamda, dataset, targets, n_cls, test_loader, semi=False, semi_percent=1,
...
def train():
    ...
    ensemble(1, opt.nh, opt.lamda, opt.dataset, targets, n_cls, test_loader, smi, opt.semi_percent, opt.model_path)
