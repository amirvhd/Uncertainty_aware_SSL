...
def download():
    ...
    download_and_extract_archive(url, download_root="~/DATA2/ISIC_data")
...
def set_path(path):
    train_img_path = os.path.join(path, 'ISIC_data/ISIC2018_Task3_Training_Input')
    train_class_path = os.path.join(path,
                                    'ISIC_data/ISIC2018_Task3_Training_GroundTruth/ISIC2018_Task3_Training_GroundTruth.csv')


    val_img_path = os.path.join(path, 'ISIC_data/ISIC2018_Task3_Validation_Input')
    val_class_path = os.path.join(path,
                                  'ISIC_data/ISIC2018_Task3_Validation_GroundTruth/ISIC2018_Task3_Validation_GroundTruth.csv')

    test_img = os.path.join(path, 'ISIC_data/ISIC2018_Task3_Test_Input')
